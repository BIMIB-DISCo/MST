...
for (type in c('accuracy', 'hamming_distance', 'sensitivity', 'specificity')) {
    for (branching in c('clean', 'convergent', 'random_columns', 'random_forest')) {
        ...
        ##            plot.id = plot.id + 1
        ##        }
        ##        pdf(paste('plot_reduced/capri_caprese', type, branching, '.pdf', sep = '_'))
        ...
        ##            plot.id = plot.id + 1
        ##        }
        ##        pdf(paste('plot_reduced/gabow', type, branching, '.pdf', sep = '_'))
        ##        multiplot(plotlist = plotlist)
        ##        dev.off()
        ##
        ...
        ##            plot.id = plot.id + 1
        ##        }
        ##        pdf(paste('plot_reduced/edmonds', type, branching, '.pdf', sep = '_'))
        ##        multiplot(plotlist = plotlist)
        ##        dev.off()
        ##
        ...
        ##            plot.id = plot.id + 1
        ##        }
        ##        pdf(paste('plot_reduced/prim_chowliu', type, branching, '.pdf', sep = '_'))
        ##        multiplot(plotlist = plotlist)
        ##        dev.off()
        ##        
