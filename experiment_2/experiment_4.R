...
experiments.single.cells.mini.scite =
    import.scite.output(result.single.cells.mini, 'single', 'mini')
save(experiments.single.cells.mini.scite,
     file = 'RData/experiments.single.cells.mini.scite.RData')
...
experiments.single.cells.mini.scite.stats =
    get.stats(experiments.single.cells.mini.scite)
save(experiments.single.cells.mini.scite.stats,
     file = "RData/experiments.single.cells.mini.scite.stats.RData")
...
for (type in c('accuracy', 'hamming_distance', 'sensitivity', 'specificity')) {
    for (branching in c('mini')) {
        ...
        pdf(paste('plot_reduced/mt', type, branching, '.pdf', sep = '_'),
            height = 5,
            width = 15)
