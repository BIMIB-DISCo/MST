...
save(dataset.multiple.biopses.low,
     file = "RData/dataset.multiple.biopses.low.RData")


## Generate dataset for multiple biopses medium

cat('dataset multiple biopses medium\n')
dataset.multiple.biopses.medium =
    parSapply(cl,
              my_experiments,
              function(x) {
...
save(dataset.multiple.biopses.medium,
     file = "RData/dataset.multiple.biopses.medium.RData")


## Generate dataset for multiple biopses high

cat('dataset multiple biopses high\n')
dataset.multiple.biopses.high =
    parSapply(cl,
              my_experiments,
              function(x) {
...
save(dataset.multiple.biopses.high,
     file = "RData/dataset.multiple.biopses.high.RData")
...
cat('scite low\n')
create.scite.input(dataset.multiple.biopses.low,
                   'multiple',
                   'low',
                   scite.sd,
                   pass.error.rates = FALSE)
cat('scite medium\n')
create.scite.input(dataset.multiple.biopses.medium,
                   'multiple',
                   'medium',
                   scite.sd,
                   pass.error.rates = FALSE)
cat('scite high\n')
create.scite.input(dataset.multiple.biopses.high,
                   'multiple',
                   'high',
