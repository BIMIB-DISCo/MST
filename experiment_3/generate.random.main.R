...
save(dataset.random.single.cells.5.nodes,
     file = "RData/dataset.random.single.cells.5.nodes.RData")
...
save(dataset.random.single.cells.10.nodes,
     file = "RData/dataset.random.single.cells.10.nodes.RData")
...
save(dataset.random.single.cells.15.nodes,
     file = "RData/dataset.random.single.cells.15.nodes.RData")
...
save(dataset.random.single.cells.20.nodes,
     file = "RData/dataset.random.single.cells.20.nodes.RData")
