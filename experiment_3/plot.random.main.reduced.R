...
for (type in c('accuracy', 'hamming_distance', 'sensitivity', 'specificity')) {
    for (branching in c('random_5', 'random_10', 'random_15', 'random_20')) {
        ...
        pdf(paste('plot_reduced/capri_caprese', type, branching, '.pdf',
                  sep = '_'),
            height = 10,
            width = 9)
        ...
        pdf(paste('plot_reduced/gabow', type, branching, '.pdf',
                  sep = '_'),
            height = 10,
            width = 9)
        multiplot(plotlist = plotlist)
        ...
        for (sample in samples) {
            p = dotplotter(results.values,
                           sample, c('edmonds_entropy.no.reg',
                                     'edmonds_pmi.no.reg',
                                     'edmonds_cpmi.no.reg',
                                     'scite_no.reg'), 
                           branching,
        ...
        pdf(paste('plot_reduced/prim_chowliu', type, branching, '.pdf',
                  sep = '_'),
            height = 10,
            width = 9)
        multiplot(plotlist = plotlist)
