...
result.random.single.cells.10.nodes =
    expand.input(dataset.random.single.cells.10.nodes, seed, cores)
save(result.random.single.cells.10.nodes,
     file = "RData/result.random.single.cells.10.nodes.RData")

### end of file -- reconstruct.random.main.10.R
