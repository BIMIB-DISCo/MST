...
my_regularizators = c("mi.no.reg.res", "pmi.no.reg.res", "cpmi.no.reg.res", "entropy.no.reg.res", "no.raising.no.reg.res", "no.raising.mi.no.reg.res", "no.raising.pmi.no.reg.res", "no.raising.cpmi.no.reg.res", "entropy.no.reg.res", 'no.reg.res')
sample_levels = 4
noise_levels = 8
...
experiments.single.cells.low.scite.stats = get.stats(
