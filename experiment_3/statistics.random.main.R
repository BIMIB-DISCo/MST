...
giulio.plot(experiments.random.single.cells.5.nodes.scite.stats,
            'single',
            'random_5')
...
giulio.plot(experiments.random.single.cells.10.nodes.scite.stats,
            'single',
            'random_10')
...
giulio.plot(experiments.random.single.cells.15.nodes.scite.stats,
            'single',
            'random_15')
...
giulio.plot(experiments.random.single.cells.20.nodes.scite.stats,
            'single',
            'random_20')
