...
sample_sizes_single_cells = c(50, 75)
e_pos_single_cells = c(0.000, 0.005, 0.010)
e_neg_single_cells = c(0.000, 0.050, 0.100)
...
print('scite single')
create.scite.input(dataset.random.single.cells.10.nodes,
                   'single',
                   'random_10',
                   scite.sd,
                   steps = 900000)
