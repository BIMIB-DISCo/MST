...
clusterExport(cl,
              c('sample_sizes_multiple_biopses',
...
save(dataset.random.multiple.biopses.5.nodes,
     file = "RData/dataset.random.multiple.biopses.5.nodes.RData")
...
save(dataset.random.multiple.biopses.10.nodes,
     file = "RData/dataset.random.multiple.biopses.10.nodes.RData")
...
save(dataset.random.multiple.biopses.15.nodes,
     file = "RData/dataset.random.multiple.biopses.15.nodes.RData")
...
save(dataset.random.multiple.biopses.20.nodes,
     file = "RData/dataset.random.multiple.biopses.20.nodes.RData")

stopCluster(cl)

print('Scite multiple')
create.scite.input(dataset.random.multiple.biopses.5.nodes,
                   'multiple',
                   'random_5',
                   scite.sd,
                   pass.error.rates = FALSE)
create.scite.input(dataset.random.multiple.biopses.10.nodes,
                   'multiple',
                   'random_10',
                   scite.sd,
                   pass.error.rates = FALSE)
create.scite.input(dataset.random.multiple.biopses.15.nodes,
                   'multiple',
                   'random_15',
                   scite.sd,
                   pass.error.rates = FALSE)
create.scite.input(dataset.random.multiple.biopses.20.nodes,
                   'multiple',
                   'random_20',
                   scite.sd,
                   pass.error.rates = FALSE)
