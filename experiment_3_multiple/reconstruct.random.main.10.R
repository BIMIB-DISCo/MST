...
result.random.multiple.biopses.10.nodes =
    expand.input(dataset.random.multiple.biopses.10.nodes,
                 seed,
                 cores,
                 pass.error.rates = FALSE)
save(result.random.multiple.biopses.10.nodes,
     file = "RData/result.random.multiple.biopses.10.nodes.RData")

### end of file -- reconstruct.random.main.R
