...
result.random.multiple.biopses.5.nodes =
    expand.input(dataset.random.multiple.biopses.5.nodes,
                 seed,
                 cores,
                 pass.error.rates = FALSE)
save(result.random.multiple.biopses.5.nodes,
     file = "RData/result.random.multiple.biopses.5.nodes.RData")
