...
giulio.plot(experiments.random.multiple.biopses.5.nodes.scite.stats,
            'multiple',
            'random_5')
...
giulio.plot(experiments.random.multiple.biopses.10.nodes.scite.stats,
            'multiple',
            'random_10')
...
giulio.plot(experiments.random.multiple.biopses.15.nodes.scite.stats,
            'multiple',
            'random_15')
...
giulio.plot(experiments.random.multiple.biopses.20.nodes.scite.stats,
            'multiple',
            'random_20')
