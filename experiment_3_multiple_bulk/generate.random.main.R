...
dataset.random.multiple.biopses.bulk.5.nodes = parSapply(cl, my_experiments, function(x){
...
save(dataset.random.multiple.biopses.bulk.5.nodes, file="RData/dataset.random.multiple.biopses.bulk.5.nodes.RData")

# generate dataset for random multiple.biopses of 10 nodes
cat('dataset random multiple.biopses.bulk of 10 nodes\n')
dataset.random.multiple.biopses.bulk.10.nodes = parSapply(cl, my_experiments, function(x){
    generate.dataset.multiple.biopses(type="random_bulk",
        samples_num = sample_sizes_multiple_biopses,
        e_pos = e_pos_multiple_biopses,
        e_neg = e_neg_multiple_biopses,
...
save(dataset.random.multiple.biopses.bulk.10.nodes, file="RData/dataset.random.multiple.biopses.bulk.10.nodes.RData")

# generate dataset for random multiple.biopses of 15 nodes
cat('dataset random multiple.biopses.bulk of 15 nodes\n')
dataset.random.multiple.biopses.bulk.15.nodes = parSapply(cl, my_experiments, function(x){
    generate.dataset.multiple.biopses(type="random_bulk",
        samples_num = sample_sizes_multiple_biopses,
        e_pos = e_pos_multiple_biopses,
        e_neg = e_neg_multiple_biopses,
...
save(dataset.random.multiple.biopses.bulk.15.nodes, file="RData/dataset.random.multiple.biopses.bulk.15.nodes.RData")

# generate dataset for random multiple.biopses of 20 nodes
cat('dataset random multiple.biopses.bulk of 20 nodes\n')
dataset.random.multiple.biopses.bulk.20.nodes = parSapply(cl, my_experiments, function(x){
    generate.dataset.multiple.biopses(type="random_bulk",
        samples_num = sample_sizes_multiple_biopses,
        e_pos = e_pos_multiple_biopses,
        e_neg = e_neg_multiple_biopses,
...
save(dataset.random.multiple.biopses.bulk.20.nodes, file="RData/dataset.random.multiple.biopses.bulk.20.nodes.RData")

stopCluster(cl)

print('scite multiple')
create.scite.input(dataset.random.multiple.biopses.bulk.5.nodes, 'multiple', 'random_5', scite.sd, pass.error.rates = FALSE)
create.scite.input(dataset.random.multiple.biopses.bulk.10.nodes, 'multiple', 'random_10', scite.sd, pass.error.rates = FALSE)
create.scite.input(dataset.random.multiple.biopses.bulk.15.nodes, 'multiple', 'random_15', scite.sd, pass.error.rates = FALSE)
create.scite.input(dataset.random.multiple.biopses.bulk.20.nodes, 'multiple', 'random_20', scite.sd, pass.error.rates = FALSE)
