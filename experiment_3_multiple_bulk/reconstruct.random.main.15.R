...
result.random.multiple.biopses.bulk.15.nodes =
    expand.input(dataset.random.multiple.biopses.bulk.15.nodes,
                 seed,
                 cores,
                 pass.error.rates = FALSE)
save(result.random.multiple.biopses.bulk.15.nodes,
     file = "RData/result.random.multiple.biopses.bulk.15.nodes.RData")

### end of file -- reconstruct.random.15.R
