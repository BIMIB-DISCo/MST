...
cat('low\n')
dataset.single.cells.random.columns.low =
    add.random.columns(dataset.single.cells.low, ncol.low)
save(dataset.single.cells.random.columns.low,
     file = 'RData/dataset.single.cells.random.columns.low.RData')

cat('medium\n')
dataset.single.cells.random.columns.medium =
    add.random.columns(dataset.single.cells.medium, ncol.medium)
save(dataset.single.cells.random.columns.medium,
     file = 'RData/dataset.single.cells.random.columns.medium.RData')

cat('high\n')
dataset.single.cells.random.columns.high =
    add.random.columns(dataset.single.cells.high, ncol.high)
save(dataset.single.cells.random.columns.high,
     file = 'RData/dataset.single.cells.random.columns.high.RData')

cat('scite low\n')
create.scite.input(dataset.single.cells.random.columns.low,
                   'single',
                   'low',
                   scite.sd)

cat('scite medium\n')
create.scite.input(dataset.single.cells.random.columns.medium,
                   'single',
                   'medium',
                   scite.sd)

cat('scite high\n')
create.scite.input(dataset.single.cells.random.columns.high,
                   'single',
                   'high',
                   scite.sd)
