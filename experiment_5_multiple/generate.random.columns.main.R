...
cat('low\n')
dataset.multiple.biopses.random.columns.low =
    add.random.columns(dataset.multiple.biopses.low, ncol.low)
save(dataset.multiple.biopses.random.columns.low,
     file = 'RData/dataset.multiple.biopses.random.columns.low.RData')

cat('medium\n')
dataset.multiple.biopses.random.columns.medium =
    add.random.columns(dataset.multiple.biopses.medium, ncol.medium)
save(dataset.multiple.biopses.random.columns.medium,
     file = 'RData/dataset.multiple.biopses.random.columns.medium.RData')

cat('high\n')
dataset.multiple.biopses.random.columns.high =
    add.random.columns(dataset.multiple.biopses.high, ncol.high)
save(dataset.multiple.biopses.random.columns.high,
     file = 'RData/dataset.multiple.biopses.random.columns.high.RData')

cat('scite low\n')
create.scite.input(dataset.multiple.biopses.random.columns.low,
                   'multiple',
                   'low',
                   scite.sd,
...
cat('scite medium\n')
create.scite.input(dataset.multiple.biopses.random.columns.medium,
                   'multiple',
                   'medium',
                   scite.sd,
                   pass.error.rates = FALSE)
...
cat('scite high\n')
create.scite.input(dataset.multiple.biopses.random.columns.high,
                   'multiple',
                   'high',
                   scite.sd, pass.error.rates = FALSE)

### end of file -- generate.random.columns.main.R
