...
dataset.random.multiple.biopses.forest.nodes = parSapply(cl, my_experiments, function(x){
...
save(dataset.random.multiple.biopses.forest.nodes, file="RData/dataset.random.multiple.biopses.forest.nodes.RData")


stopCluster(cl)

print('scite multiple')
create.scite.input(dataset.random.multiple.biopses.forest.nodes, 'multiple', 'random_forest', scite.sd)
