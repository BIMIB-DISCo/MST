...
sample.random.bayesian.bulk.significant.tree <- function ( samples_num, e_pos, e_neg, nodes, min_significance = 0.6, max_significance = 0.90, sample_significance = 0.00001 ) {
