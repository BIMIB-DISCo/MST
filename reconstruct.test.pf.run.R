...
run.reconstructions <- function( dataset, true_tree ) {
    ...
    edmonds = list(model = res,
        no.reg.adj=adj.matrix.edmonds.no.reg, no.reg.res=results.edmonds.no.reg,
        pf.pre.adj=adj.matrix.edmonds.pf.pre, pf.pre.res=results.edmonds.pf.pre,
        pf.post.adj=adj.matrix.edmonds.pf.post, pf.post.res=results.edmonds.pf.post)
