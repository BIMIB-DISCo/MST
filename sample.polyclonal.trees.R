...
"sample.single.cells.polyclonal.low" = function ( samples_num, nodes_probabilities = NA, e_pos, e_neg ) {
	
	# create the structure with the valid samples
	dataset = array(0,c(7,6))
	dataset[2,1] = 1
	dataset[3,1] = 1
	dataset[3,2] = 1
	dataset[4,1] = 1
	...
	# sample the dataset
	sampled_dataset = dataset[sample(1:nrow(dataset),size=samples_num,replace=TRUE,prob=samples_probabilities),]
...
"sample.single.cells.polyclonal.medium" = function ( samples_num, nodes_probabilities = NA, e_pos, e_neg ) {
	
	# create the structure with the valid samples
	dataset = array(0,c(12,11))
	dataset[2,1] = 1
	dataset[3,1] = 1
	dataset[3,2] = 1
	dataset[4,1] = 1
...
"sample.single.cells.polyclonal.high" = function ( samples_num, nodes_probabilities = NA, e_pos, e_neg ) {
	
	# create the structure with the valid samples
	dataset = array(0,c(18,17))
	dataset[2,1] = 1
	dataset[3,1] = 1
	dataset[3,2] = 1
	dataset[4,1] = 1
...
"sample.multiple.biospes.from.single.cells" = function ( clones_num, single_cell_type, nodes_probabilities = NA, e_pos, e_neg ) {
...
"sample.multiple.biopses.polyclonal.low" = function ( samples_num, clones_probabilities, nodes_probabilities = NA, e_pos, e_neg, wild_type ) {
	...
	sampled_dataset = sapply(res.matrix[,1],function(x){sample.multiple.biospes.from.single.cells(clones_probabilities,"low",nodes_probabilities,e_pos,e_neg)})
	sampled_dataset = t(sampled_dataset)
	
	if(wild_type_samples>0) {
		sampled_dataset = rbind(array(0,c(wild_type_samples,6)),sampled_dataset)
	}
...
"sample.multiple.biopses.polyclonal.medium" = function ( samples_num, clones_probabilities, nodes_probabilities = NA, e_pos, e_neg, wild_type ) {
	...
	sampled_dataset = sapply(res.matrix[,1],function(x){sample.multiple.biospes.from.single.cells(clones_probabilities,"medium",nodes_probabilities,e_pos,e_neg)})
	sampled_dataset = t(sampled_dataset)
	
	if(wild_type_samples>0) {
		sampled_dataset = rbind(array(0,c(wild_type_samples,11)),sampled_dataset)
	}
...
"sample.multiple.biopses.polyclonal.high" = function ( samples_num, clones_probabilities, nodes_probabilities = NA, e_pos, e_neg, wild_type ) {
	...
	sampled_dataset = sapply(res.matrix[,1],function(x){sample.multiple.biospes.from.single.cells(clones_probabilities,"high",nodes_probabilities,e_pos,e_neg)})
	sampled_dataset = t(sampled_dataset)
	
	if(wild_type_samples>0) {
		sampled_dataset = rbind(array(0,c(wild_type_samples,17)),sampled_dataset)
	}
...
"apply.noise.to.sample" = function ( my_sample, e_pos, e_neg ) {
